...
mesa = User.objects.create_user(username='mesadepartes', password='mesadepartes', email='mesadepartes@pcm.com')
mesa.save()
...
user = User.objects.create_user(username='Jaspers', password='Jaspers', email='Jaspers@pcm.com')
user.save()

iu = InternalUser(user=user,nombres='Jaspers',apellidos='Huanay',codigoUsuario='42',codDependencia='IA',dependencia='IA')
iu.save()
